...
namespace Logic.BehaviorTree
{
    ...
    public class Node : Basic.Ability
    {
        ...
        public Logic.Config.BehaviorTree Config { get; set; }
        ...
        {
            Config = (Logic.Config.BehaviorTree)args[0];
        ...
        public void BuildChildRelations()
        {
            ...
            {
                var existingNode = Logic.Agent.Instance.Content.Get<Node>(n => n.Config.Id == childId);
        ...
        {
            Logic.Design.BehaviorTree design = Logic.Design.Agent.Instance.Content.Get<Logic.Design.BehaviorTree>(b => b.id == Config.Id);
