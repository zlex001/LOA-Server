...
namespace Logic.Display
{
    public class Right
    {
        ...
        public static List<Option.Item> Shop(Player player, Ability target)
        {
            return new List<Option.Item>
            {
                OptionHelper.BuildButton(Logic. Operation.Type.Buy, Text.Agent.Instance.Get((int)Logic.Operation.Type.Buy, player)),
                OptionHelper.BuildButton(Logic.Operation.Type.Sell, Text.Agent.Instance.Get((int)Logic.Operation.Type.Sell, player))
            };
        }

        public static List<global::Data.Option.Item> Teleport(Player player, global::Data.Ability target)
        {
            var items = new List<global::Data.Option.Item>();

            if (target is Life teleporter && player.Map != null)
            {
                var teleportMaps = global::Data.Agent.Instance.Content.Gets<global::Data.Map>()
                    .Where(m => m.Type == global::Data.Map.Types.Teleport)
                    .ToList();
                ...
                if (teleportMaps.Count > 0)
                {
                    ...
                    if (currentMapIndex >= 0)
                    {
                        ...
                        foreach (var targetIndex in targetIndices)
                        {
                            ...
                            items.Add(new global::Data.Option.Item(global::Data.Option.Item.Type.Button, Logic.Text.Name.Map(targetMap, player)));
                        }
                    }
                }
            }
        ...
        {
            if (target is global::Data.Item item)
            {
                ...
                var slider = new Option.Item
                {
                    ...
                    {
                        { "Text", Text.Agent.Instance.Get(Logic. Operation.Type.Pick, player) },
        ...
        public static void TeleportClick(Player player, global::Data.Ability target, int index)
        {
            if (target is Life teleporter && player.Map != null)
            {
                var teleportMaps = global::Data.Agent.Instance.Content.Gets<global::Data.Map>()
        ...
        {
            if (target is global::Data.Item item && player.Option != null && player.Option.Type == Option.Types.PickOrder)
            {
                int count = player.Option.Setting.SliderValue;
                Logic.Exchange.Pick.Do(player, item, count);
        ...
        public static List<Option.Item> Give(Player sub, Ability obj)
        {
            ...
            foreach (var character in Exchange.Give.Availability(sub))
            {
                ...
                {
                    results.Add(new Option.Item(Option.Item.Type.Button, ("Text", Logic.Text.Decorate.Item(item, sub)), ("Action", $"GiveItem_{character.GetHashCode()}")));
                }
                else if (character is Life life)
                {
                    results.Add(new Option.Item(Option.Item.Type.Button, ("Text", Logic.Text.Decorate.Life(life, sub)), ("Action", $"GiveItem_{character.GetHashCode()}")));
                }
            }
            return results;
        }
        ...
        {
            if (target is global::Data.Item item && player.Option != null && player.Option.Type == Option.Types.GiveOrder)
            {
                ...
                else if (option?.Relates?.FirstOrDefault() is global::Data.Item item_receiver)
                {
        ...
        public static List<Option.Item> Buy(Player player, Ability target)
        {
            ...
            Logic.Infrastructure.Shop shop = Infrastructure.Agent.GetShop(character);
        ...
        public static List<Option.Item> DropOrder(Player player, Ability target)
        {
            if (target is Item item)
            {
                ...
                var slider = new Option.Item
                {
                    ...
                    data = new Dictionary<string, string>
                    {
                        { "Text", Text.Agent.Instance.Get((int)Logic.Operation.Type.Drop, player) },
                        { "SliderValues", JsonConvert.SerializeObject(new int[] { setting.SliderMin, setting.SliderValue, setting.SliderMax }) },
                        { "ValueColor", "WHT" }
                    }
                };
        ...
        public static List<Option.Item> Mall(Player player, Ability target)
        {
            ...
            var input = new Option.Item
            {
                ...
                data = new Dictionary<string, string>
                {
                    { "PlaceholderText", Text.Agent.Instance.Get(global::Data.Text.Labels.SearchProducts, player.Language) },
                    { "Text", player.Option?.Setting?.Filter ?? "" }
                }
            };
            results.Add(input);
            ...
            var mallConfigs = global::Data.Config.Agent.Instance.Content.Gets<global::Data.Config.Mall>()
            ...
            {
                string noResultsText = Text.Agent.Instance.Get(global::Data.Text.Labels.NoSearchResults, player.Language);
                results.Add(new Option.Item(Option.Item.Type.Text, noResultsText));
                
                string clearSearchText = Text.Agent.Instance.Get(global::Data.Text.Labels.ClearSearch, player.Language);
        ...
        private static bool ShouldShowMallItem(Option option, global::Data.Config.Mall mallConfig, Player player)
        {
        ...
        private static string GetMallTypeName(global::Data.Config.Mall.Types type, Player player)
        {
            return type switch
            {
                global::Data.Config.Mall.Types.Subscription => Text.Agent.Instance.Get(global::Data.Text.Labels.MallTypeSubscription, player.Language),
                global::Data.Config.Mall.Types.Experience => Text.Agent.Instance.Get(global::Data.Text.Labels.MallTypeExperience, player.Language),
                global::Data.Config.Mall.Types.Equipment => Text.Agent.Instance.Get(global::Data.Text.Labels.MallTypeEquipment, player.Language),
                global::Data.Config.Mall.Types.Pack => Text.Agent.Instance.Get(global::Data.Text.Labels.MallTypePack, player.Language),
                _ => Text.Agent.Instance.Get(global::Data.Text.Labels.MallTypeOther, player.Language),
            };
        }
        ...
        private static void OpenMallOrderPanel(Player player, global::Data.Config.Mall mallConfig)
        {
        ...
        public static List<Option.Item> MallOrder(Player player, Ability target)
        {
            ...
            int maxBuyable = Logic.Mall.Agent.Instance.GetMaxBuyable(player, mallConfig);
            ...
            string buyLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.BuyLabel, player.Language);
            string totalLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.Total, player.Language);
            string gemLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.Gem, player.Language);
        ...
        public static void MallOrderConfirm(Player player, Ability target, int index)
        {
            ...
            bool success = Logic.Mall.Purchase.Do(player, mallConfig, count, out var reason);
            if (!success)
            {
                string tip = reason switch
                {
                    Logic.Mall.Purchase.FailReason.NoGem or Logic.Mall.Purchase.FailReason.InsufficientGem 
                        => Logic.Text.Agent.Instance.Get(global::Data.Text.Labels.MallInsufficientGem, player.Language),
                    Logic.Mall.Purchase.FailReason.ExceedMax 
                        => Logic.Text.Agent.Instance.Get(global::Data.Text.Labels.MallLimitReached, player.Language),
                    Logic.Mall.Purchase.FailReason.CannotReceive 
                        => Logic.Text.Agent.Instance.Get(global::Data.Text.Labels.MallCannotReceive, player.Language),
                    _ => ""
                };
