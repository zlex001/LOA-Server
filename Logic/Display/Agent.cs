...
namespace Logic.Display
{
    public class Agent : Agent<Agent>
    {
        ...
        public void Init()
        {
            ...
            Register(global::Data.Option.LeftPanel.Teleport, build: Left.Teleport);
            Register(global::Data.Option.RightPanel.Teleport, build: Right.Teleport, onClick: Right.TeleportClick);
            ...
            global::Data.Agent.Instance.Content.Remove.Register(typeof(Player), OnUnbundlePlayer);
            global::Data.Agent.Instance.Content.Add.Register(typeof(Option), OnPlayerAddOption);
            global::Data.Agent.Instance.Content.Remove.Register(typeof(Option), OnPlayerRemoveOption);
        ...
        public Net.Protocol.Option CreateOptionProtocol(global::Data.Option option)
        {
            var info = (global::Data.Option.LeftPanel)Enum.Parse(typeof(global::Data.Option.LeftPanel), option.Type.ToString());
            var oper = (global::Data.Option.RightPanel)Enum.Parse(typeof(global::Data.Option.RightPanel), option.Type.ToString());
        ...
        public List<global::Data.Option.Item> Create(global::Data.Player player, Enum type, global::Data.Ability target)
        {
            ...
            return new List<global::Data.Option.Item>();
        }

        public void Execute(global::Data.Player player, Enum type, global::Data.Ability target, int index)
        {
        ...
        public void ExecuteConfirm(global::Data.Player player, Enum type, global::Data.Ability target, int index)
        {
            if (confirmHandlers.TryGetValue(type, out var handler))
                handler(player, target, index);
        }
        public List<global::Data.Option.Item> Generate(global::Data.Player player, global::Data.Ability target)
        {
            var results = new List<global::Data.Option.Item>();
        ...
        private void OnAddPlayer(params object[] args)
        {
            ...
            player.monitor.Register(global::Data.Option.Event.Refresh, OnRefresh);

            player.Content.Add.Register(typeof(global::Data.Option), OnPlayerAddOption);
            player.Content.Remove.Register(typeof(global::Data.Option), OnPlayerRemoveOption);
        ...
        private void OnUnbundlePlayer(params object[] args)
        {
            ...
            {
                Unregister(part.data.after, global::Data.Part.Data.Hp);
            }
            ...
            player.Content.Remove.Unregister(typeof(global::Data.Option), OnPlayerRemoveOption);
            player.Content.Add.Unregister(typeof(global::Data.Option), OnPlayerAddOption);
        ...
        private void OnAfterPlayerMp(global::Data.Player player, object[] args)
        {
            int v = (int)args[0];
            string color = Utils.Text.GetDangerRatioColor((double)player.Mp / player.data.GetMax<int>(global::Data.Life.Data.Mp));
            Net.Tcp.Instance.Send(player, new Net.Protocol.DataPair(Net.Protocol.DataPair.Type.Mp, [player.Mp, (int)player.MaxMp], color));
        }
        private void OnAfterPlayerLp(global::Data.Player player, object[] args)
        {
            string color = Utils.Text.GetDangerRatioColor(player.Lp / player.data.GetMax<double>(global::Data.Life.Data.Lp));
        ...
        private void OnBeforePlayerExp(global::Data.Player player, object[] args)
        {
        ...
        private void ListenTargetLife(Player viewer, Life target)
        {
            ...
            {
                Register(part.data.before, global::Data.Part.Data.Hp, viewer, OnBeforeTargetPartHpChanged);
            }
        ...
        private void UnlistenTargetLife(Player viewer, Life target)
        {
            foreach (var part in target.Content.Gets<Part>())
            {
                Unregister(part.data.before, global::Data.Part.Data.Hp);
            }
        ...
        private void OnPlayerAddOptionSettings(params object[] args)
        {
            ...
            else if (settings.Type == Option.Types.Mall)
            {
                ...
                {
                    Text.Agent.Instance.Get(global::Data.Text.Labels.MallTypeSubscription, player.Language),
                    Text.Agent.Instance.Get(global::Data.Text.Labels.MallTypeExperience, player.Language),
                    Text.Agent.Instance.Get(global::Data.Text.Labels.MallTypeEquipment, player.Language),
                    Text.Agent.Instance.Get(global::Data.Text.Labels.MallTypeOther, player.Language),
                    Text.Agent.Instance.Get(global::Data.Text.Labels.MallTypePack, player.Language),
        ...
        private class ContainerChangeListener : IDisposable
        {
            ...
            public ContainerChangeListener(Player viewer, Item container)
            {
                ...
                {
                    item.data.after.Register(global::Data.Item.Data.Count, OnContainerItemCountChanged);
                }
            }
            ...
            private void OnContainerItemAdded(params object[] args)
            {
                if (!disposed && viewer.Option != null && viewer.Option.Relates.Contains(container))
                {
                    ...
                    // 监听新加入Item的数量变化
                    addedItem.data.after.Register(global::Data.Item.Data.Count, OnContainerItemCountChanged);
                    Agent.Instance.Refresh(viewer);
                }
            }
            ...
            private void OnContainerItemRemoved(params object[] args)
            {
                if (!disposed && viewer.Option != null && viewer.Option.Relates.Contains(container))
                {
                    ...
                    // 取消对移除Item的监听
                    removedItem.data.after.Unregister(global::Data.Item.Data.Count, OnContainerItemCountChanged);
                    Agent.Instance.Refresh(viewer);
                }
            }
            ...
            public void Dispose()
            {
                if (!disposed)
                {
                    ...
                    foreach (var item in containerItems)
                    {
                        item.data.after.Unregister(global::Data.Item.Data.Count, OnContainerItemCountChanged);
                    }
        ...
        public static List<Net.Protocol.Characters.CharacterData> GetCharactersForDisplay(global::Data.Player player)
        {
            ...
            foreach (var c in Perception.Agent.Instance.GetVisibleCharacters(player))
            {
                ...
                if (c is global::Data.Life life)
                {
                    ...
                    progress = (!life.State.Is(global::Data.Life.States.Unconscious) && life.Relation.Where(kvp => kvp.Value < 0).OrderBy(kvp => kvp.Value).Select(kvp => kvp.Key).Any(t => t is Life l && !l.State.Is(global::Data.Life.States.Unconscious) && l.Map == life.Map) ? life.Action : 0);
        ...
        public static (int CurrentValue, int MaxValue, string Color) GetResourceForDisplay(global::Data.Player player, string resourceType)
        {
        ...
        public static Net.Protocol.WorldMap CreateWorldMap(global::Data.Player player)
        {
            var sceneInfos = new List<Net.Protocol.WorldMap.SceneInfo>();
            
            foreach (var (sceneCid, pos) in global::Data.Design.World.SceneCoordinates)
            {
                var sceneDesign = global::Data.Design.Agent.Instance.Content.Get<global::Data.Design.Scene>(s => s.cid == sceneCid);
                if (sceneDesign == null) continue;
                
                var multilingual = global::Data.Design.Agent.Instance.Content.Get<global::Data.Design.Multilingual>(m => m.cid == sceneDesign.name);
                if (multilingual == null) continue;
                
                string sceneName = Logic.Text.Agent.Instance.Get(multilingual.id, player);
        ...
        private static string GetSceneType(global::Data.Scene scene)
        {
            if (scene.Config == null) return "其他";
            if (scene is global::Data.Maze) return "迷宫";
            return string.IsNullOrEmpty(scene.Config.Type) ? "其他" : scene.Config.Type;
        }

        public static Dictionary<string, (int CurrentValue, int MaxValue, string Color)> GetAllResourcesForDisplay(global::Data.Player player)
        {
