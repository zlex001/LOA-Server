...
namespace Logic.Display
{
    public class Left
    {
        public static List<Option.Item> Operation(Player player, Ability target)
        {
            ...
            {
                // Name
                items.Add(new Option.Item(Logic.Text.Decorate.Life(life, player)));
                // Description
                ...
                string distanceLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.Distance, player);
            ...
            if (target is global::Data.Item item && item.Map != player.Map
                && !(item.Parent is Part part && part.Parent == player))
            {
                // Name
                items.Add(new Option.Item(Logic.Text.Decorate.Item(item, player)));
                // Description
                items.Add(new Option.Item($"{Utils.Text.Indent(0)}{Logic.Text.Description.Item(item, player)}"));
                // Distance
        ...
        public static List<global::Data.Option.Item> Teleport(Player player, global::Data.Ability target)
        {
            ...
            {
                items.Add(new global::Data.Option.Item(global::Data.Option.Item.Type.Text, Logic.Text.Decorate.Life(teleporter, player)));

                string speech = Logic.Text.Agent.Instance.Get(global::Data.Text.Labels.TeleporterSpeech, player.Language);
                items.Add(new global::Data.Option.Item(global::Data.Option.Item.Type.Text, speech));
            }
        ...
        public static List<Option.Item> Mall(Player player, Ability target)
        {
            ...
            string mallTitle = Text.Agent.Instance.Get((int)Logic.Operation.Type.Mall, player);
            ...
            string monthlyExpLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.MonthlyExp, player.Language);
            
            // 2: BasicCard (Angel's Blessing) - as level 0 item
            string basicCardName = Text.Agent.Instance.Get(global::Data.Text.Labels.BasicMonthlyCard, player.Language);
            ...
            if (hasBasicCard)
            {
                ...
                string basicDaysText = Text.Agent.Instance.GetDynamic(global::Data.Text.Labels.DaysRemaining, player.Language, 
            ...
            else
            {
                ...
                string notSubscribed = Text.Agent.Instance.Get(global::Data.Text.Labels.NotSubscribed, player.Language);
                items.Add(new Option.Item($"{Utils.Text.Indent(1)}{notSubscribed}"));
            }
            
            // 5: PremiumCard (God's Blessing) - as level 0 item
            string premiumCardName = Text.Agent.Instance.Get(global::Data.Text.Labels.PremiumMonthlyCard, player.Language);
            ...
            if (hasPremiumCard)
            {
                ...
                string premiumDaysText = Text.Agent.Instance.GetDynamic(global::Data.Text.Labels.DaysRemaining, player.Language, 
            ...
            if (hasAnyCard)
            {
                string claimLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.ClaimMonthlyExp, player.Language);
            ...
            string expMultiplierLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.ExpMultiplier, player.Language);
            ...
            {
                string characterLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.Character, player.Language);
                string skillLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.SkillLabel, player.Language);
                string petLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.Pet, player.Language);
                
                if (player.BenefitCountForLife > 0)
                {
                    string characterUses = Text.Agent.Instance.GetDynamic(global::Data.Text.Labels.Uses, player.Language, ("count", player.BenefitCountForLife.ToString()));
                    items.Add(new Option.Item($"{Utils.Text.Indent(1)}{characterLabel}: {characterUses}"));
                }
                if (player.BenefitCountForSkill > 0)
                {
                    string skillUses = Text.Agent.Instance.GetDynamic(global::Data.Text.Labels.Uses, player.Language, ("count", player.BenefitCountForSkill.ToString()));
                    items.Add(new Option.Item($"{Utils.Text.Indent(1)}{skillLabel}: {skillUses}"));
                }
                if (player.BenefitCountForLive > 0)
                {
                    string petUses = Text.Agent.Instance.GetDynamic(global::Data.Text.Labels.Uses, player.Language, ("count", player.BenefitCountForLive.ToString()));
            ...
            else
            {
                ...
                string noneLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.NotSubscribed, player.Language);
        ...
        public static void MallClick(Player player, Ability target, int index)
        {
            ...
            if (index == 1)
            {
                ...
                {
                    case global::Data.Database.Device.Platforms.Android:
                        Logic.Recharge.Instance.CreateAlipayOrder(player);
                        break;
                    case global::Data.Database.Device.Platforms.IPhonePlayer:
        ...
        public static List<Option.Item> CardInput(Player player, Ability target)
        {
            ...
            items.Add(new Option.Item(Option.Item.Type.Text, 
                ("Text", Text.Agent.Instance.Get(global::Data.Text.Labels.RechargeCard, player.Language))));
            items.Add(new Option.Item(Option.Item.Type.Input,
                ("Text", ""),
                ("PlaceholderText", Text.Agent.Instance.Get(global::Data.Text.Labels.CardInputPlaceholder, player.Language))));
        ...
        public static void CardInputConfirm(Player player, Ability target, int index)
        {
            ...
            player.monitor.Fire(global::Data.Player.Event.CardPurchase, player, cardCode);
        ...
        public static List<Option.Item> MallOrder(Player player, Ability target)
        {
            ...
            if (mallConfig.Type == global::Data.Config.Mall.Types.Subscription)
            {
                ...
                string blessingEffectsLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.BlessingEffects, player.Language);
                items.Add(new Option.Item($"{Utils.Text.Indent(0)}{blessingEffectsLabel}:"));
                
                // Benefits list
                global::Data.Text.Labels benefitLabel = isPremium 
                    ? global::Data.Text.Labels.PremiumMonthlyCardBenefits 
                    : global::Data.Text.Labels.BasicMonthlyCardBenefits;
                ...
                // Price
                string priceLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.Price, player.Language);
                items.Add(new Option.Item($"{Utils.Text.Indent(0)}{priceLabel}: {mallConfig.Price}"));
            }
            // Experience type - show current count
            else if (mallConfig.Type == global::Data.Config.Mall.Types.Experience)
            {
                // Description
                ...
                switch (expType)
                {
                    case 2:  // Character Exp
                        currentLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.Character, player.Language);
                        currentCount = player.BenefitCountForLife;
                        break;
                    case 3:  // Skill Exp
                        currentLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.SkillLabel, player.Language);
                        currentCount = player.BenefitCountForSkill;
                        break;
                    case 4:  // Pet Exp
                        currentLabel = Text.Agent.Instance.Get(global::Data.Text.Labels.Pet, player.Language);
                ...
                {
                    string usesText = Text.Agent.Instance.GetDynamic(global::Data.Text.Labels.Uses, player.Language, 
        ...
        private static List<global::Data.Option.Item> GenerateOptionItems(global::Data.Option.Item.Type itemType, string[] texts)
        {
            var items = new List<global::Data.Option.Item>();
            foreach (string text in texts)
            {
                items.Add(new global::Data.Option.Item
                {
                    type = itemType,
