...
namespace Logic.Quest
{
    public static class DialogueSender
    {
        ...
        public static void Do(Player player, global::Data.Quest quest)
        {
            var lines = new List<Net.Protocol.Story.Line>();
            
            foreach (var dialogueId in quest.Config.dialogues)
            {
                var dialogueConfig = global::Data.Config.Agent.Instance.Content.Get<global::Data.Config.Dialogue>(d => d.Id == dialogueId);
