...
namespace Logic
{
    public class Manager : Data.Core
    {
        ...
        public override void Init(params object[] args)
        {
            ...
            global::Data.Life.ConditionChecker = (target, conditions) => Logic.Condition.CheckWithReason(target, conditions);

            global::Data.Config.SingleCondition.ConditionChecker = (ability, conditions, eventArgs) => Logic.Condition.Check((global::Data.Ability)ability, conditions, eventArgs);
            global::Data.Config.SingleCondition.SingleConditionChecker = (target, condition) => Logic.Condition.Check(target, condition);
        ...
        //                try
        //                {
        //                    var players = global::Data.Agent.Instance.Content.Gets<global::Data.Player>().ToList();
        ...
        //                    global::Data.Database.Agent.Instance.Save<global::Data.Database.Device>(global::Data.Config.MySQL.ConnectionString);
        //                    global::Data.Database.Agent.Instance.Save<global::Data.Database.Player>(global::Data.Config.MySQL.ConnectionString);
        ...
        private void OnLogicManagerOpenChanged(params object[] args)
        {
            ...
            if (open)
            {
                ...
                while (global::Data.Agent.Instance.data.Get<bool>(global::Data.Agent.Data.Open))
                {
                    SafetyNet.Execute(() =>
                    {
            ...
            else
            {
                ...
                var players = global::Data.Agent.Instance.Content.Gets<Player>().ToList();
                ...
                try
                {
                    ...
                    global::Data.Database.Agent.Instance.Save<global::Data.Database.Player>(global::Data.Config.MySQL.ConnectionString);
                    var playerCount = global::Data.Database.Agent.Instance.Content.Gets<global::Data.Database.Player>().Count();
        ...
        private void ScheduleShutdown()
        {
            ...
            {
                global::Data.Agent.Instance.data.Change(global::Data.Agent.Data.Open, false);
            });
        ...
        private void OnDecisecondUpdate(params object[] args)
        {
            ...
            var allLives = global::Data.Agent.Instance.Content.Gets<Life>().ToList();
            ...
            if (totalTime > 100)
            {
                ...
                {
                    if (life.BtRoot != null && !life.State.Is(global::Data.Life.States.Unconscious)) activeBehaviorTrees++;
                }
        ...
        private void OnSecondUpdate(params object[] args)
        {
            ...
            var allItems = global::Data.Agent.Instance.Content.Gets<Item>().ToList();
