...
namespace Logic
{
    public class Life : Character<Config.Life>
    {
        ...
        public Logic.BehaviorTree.Node CurrentExecutingNode { get; set; }
        public Logic.BehaviorTree.Node BtRoot { get; set; }
        ...
        public Life() : base()
        {
            ...
            for (int i = 1; i < 9; i++)
            {
                Load<Logic.Config.Movement, Logic.Movement>(i);
            }
        ...
        private void ClearAllHateTowardsMe()
        {
            if (Map != null)
            {
                string myName = this is Logic.Player p ? p.Id : this.GetType().Name;
                ...
                foreach (var life in Map.Content.Gets<Life>())
                {
                    ...
                    {
                        string lifeName = life is Logic.Player lp ? lp.Id : life.GetType().Name;
