...
public static class Robbery
{
    ...
    public static void Sentence(Life criminal, Item stolenItem, bool hasWitnesses)
    {
        ...
        if (Agent.HasWitnesses(criminal, out List<Life> witnesses))
        {
            ...
            {
                global::Data.Text.Labels label = hasWitnesses ? global::Data.Text.Labels.WitnessRobbery : global::Data.Text.Labels.WitnessTheft;
                Logic.Talk.Say.Do(witness, label, ("criminal", criminal));
            }
        }

        double modifier = stolenItem != null ? 1.0 + (stolenItem.Price / 1000.0) : 1.0;
        global::Data.Life.Crime crime = hasWitnesses ? global::Data.Life.Crime.Robbery : global::Data.Life.Crime.Theft;
