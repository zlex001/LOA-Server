...
namespace Logic.Subscription
{
    ...
    public static class Agent
    {
        ...
        private static void OnAddPlayer(params object[] args)
        {
            ...
            player.data.after.Register(global::Data.Life.Data.Exp, OnPlayerExpChanged);
            
            // Register Option events for Mall panel refresh (Option is added to player.Content)
            player.Content.Add.Register(typeof(global::Data.Option), OnAddOption);
            player.Content.Remove.Register(typeof(global::Data.Option), OnRemoveOption);
        ...
        {
            global::Data.Player player = (global::Data.Player)args[1];
            player.data.after.Unregister(global::Data.Life.Data.Exp, OnPlayerExpChanged);
            
            // Unregister Option events
            player.Content.Add.Unregister(typeof(global::Data.Option), OnAddOption);
            player.Content.Remove.Unregister(typeof(global::Data.Option), OnRemoveOption);
        ...
        {
            double bonus = 1.0;
            if (HasBasicCard(player)) bonus += global::Data.Constant.BasicMonthlyCardExpBonus;
            if (HasPremiumCard(player)) bonus += global::Data.Constant.PremiumMonthlyCardExpBonus;
            return bonus;
        }
        ...
        {
            double rate = 0.0;
            if (HasBasicCard(player)) rate += global::Data.Constant.BasicMonthlyCardMonthlyExp;
            if (HasPremiumCard(player)) rate += global::Data.Constant.PremiumMonthlyCardMonthlyExp;
            return rate;
        }
        ...
        {
            double rate = global::Data.Constant.FreePlayerTaxRate;
            if (HasBasicCard(player)) rate -= global::Data.Constant.BasicMonthlyCardTaxReduction;
            if (HasPremiumCard(player)) rate -= global::Data.Constant.PremiumMonthlyCardTaxReduction;
        ...
        {
            int slots = global::Data.Constant.FreePlayerConsignmentSlots;
            if (HasBasicCard(player)) slots += global::Data.Constant.BasicMonthlyCardConsignmentSlotsBonus;
            if (HasPremiumCard(player)) slots += global::Data.Constant.PremiumMonthlyCardConsignmentSlotsBonus;
            return Math.Min(slots, global::Data.Constant.MaxConsignmentSlots);
        }
        ...
        {
            int credit = 0;
            if (HasBasicCard(player)) credit += global::Data.Constant.BasicMonthlyCardDailyCredit;
            if (HasPremiumCard(player)) credit += global::Data.Constant.PremiumMonthlyCardDailyCredit;
            return credit;
        }
        ...
        {
            int count = 0;
            if (HasBasicCard(player)) count += global::Data.Constant.BasicMonthlyCardDailyExpMultiplier;
            if (HasPremiumCard(player)) count += global::Data.Constant.PremiumMonthlyCardDailyExpMultiplier;
            return count;
        }
        ...
        public static void AccumulateMonthlyExp(Player player)
        {
            ...
            if (HasBasicCard(player))
            {
                ...
                if (validSeconds > 0)
                {
                    double basicExpGain = monthlyRate * global::Data.Constant.BasicMonthlyCardMonthlyExp * expBonus * validSeconds;
            ...
            if (HasPremiumCard(player))
            {
                ...
                if (validSeconds > 0)
                {
                    double premiumExpGain = monthlyRate * global::Data.Constant.PremiumMonthlyCardMonthlyExp * expBonus * validSeconds;
        ...
        public static int ClaimMonthlyExp(Player player)
        {
            ...
            if (wholeExp > 0)
            {
                ...
                string message = Logic.Text.Agent.Instance.GetDynamic(
                    global::Data.Text.Labels.MonthlyExpClaimed, 
                    player.Language, 
