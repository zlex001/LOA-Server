...
namespace Logic.Cast
{
    public class Craft
    {
        public Craft(string type, Movement.Effect effect)
        {
            ...
            foreach (var config in global::Data.Config.Agent.Instance.Content.Gets<global::Data.Config.Item>())
            {
        ...
        private List<global::Data.Config.Item> materials = new List<global::Data.Config.Item>();
        private List<global::Data.Config.Item> products = new List<global::Data.Config.Item>();

        private Dictionary<string, float> Requirement(global::Data.Config.Item product)
        {
        ...
        private void Do(Life sub, Movement movement, Character obj, Part part)
        {
            ...
            var product = obj.Load<global::Data.Config.Item, Item>(selected.Id, 1);
            Broadcast.Instance.Local(obj, [Logic.Text.Agent.Instance.Id(global::Data.Text.Labels.Craft)], ("sub", sub), ("product", product), ("point", point));
            Logic.Exchange.Pick.Do(sub, product, 1);
        }
        public List<global::Data.Config.Item> Availables(Character point)
        {
            var result = new List<global::Data.Config.Item>();
