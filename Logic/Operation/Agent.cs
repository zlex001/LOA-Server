...
namespace Logic.Operation
{
    ...
    public class Agent
    {
        ...
        private static bool IsSameMap(Player player, global::Data.Ability target)
        {
            if (player?.Map == null) return false;
            if (target is global::Data.Item item)
            {
                // Items equipped on player's Part are always accessible
                if (item.Parent is global::Data.Part part && part.Parent == player)
                {
                    return true;
                }
        ...
        private bool CanAttack(Player player, global::Data.Ability target)
        {
        ...
        private bool IsAttackableResource(global::Data.Item item)
        {
            if (item == null) return false;
            return item.Parent is not global::Data.Part;
        }
        ...
        public void Init()
        {
            ...
            Display.Agent.Instance.Register(Type.Use, (p, t) => IsSameMap(p, t) && t is global::Data.Item item && Use.Agent.Instance.Can(p, item), (p, t) => new List<Option.Item> { Item.Use(p, t) }, (p, t, i) => Excute.Use(p, t));
            ...
            Display.Agent.Instance.Register(Type.Equip, (p, t) => Exchange.Equip.Instance.Can(p, t as global::Data.Item), (p, t) => new List<Option.Item> { Item.Equip(p, t) }, (p, t, i) => Excute.Equip(p, t));
            Display.Agent.Instance.Register(Type.UnEquip, (p, t) => Exchange.Unequip.Can(p, t as global::Data.Item), (p, t) => new List<Option.Item> { Item.Unequip(p, t) }, (p, t, i) => Excute.Unequip(p, t));
            ...
            Display.Agent.Instance.Register(Type.Enter, (p, t) => IsSameMap(p, t) && t is global::Data.Item item && Move.Enter.Can(p, item), (p, t) => new List<Option.Item> { Item.Enter(p, t) }, (p, t, i) => Excute.Enter(p, t));
