...
{
    public class Follow : Logic.Agent<Follow>
    {
        ...
        public static bool Can(Life follower, global::Data.Ability target)
        {
        ...
        private static void OnBeforeLifeLeaderChanged(params object[] args)
        {
            ...
            if (o != null)
            {
                ...
                Broadcast.Instance.Local(life, [Text.Agent.Instance.Id(global::Data.Text.Labels.FollowStop)], ("sub", life), ("obj", o));
            }
            ...
            if (v != null)
            {
                ...
                Broadcast.Instance.Local(life, [Text.Agent.Instance.Id(global::Data.Text.Labels.FollowStart)], ("sub", life), ("obj", v));
            }
        }
