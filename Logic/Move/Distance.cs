...
namespace Logic.Move
{
    public static class Distance
    {
        ...
        {
            List<T> candidates = global::Data.Agent.Instance.Content.Gets<T>(predicate);
        ...
        {
            List<Map> maps = global::Data.Agent.Instance.Content.Gets<Map>(predicate);
        ...
        public static int Get(Map start, Map destination)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (!global::Data.Agent.Instance.Content.Has(s => s.Database.id == path, out Scene next))
                        {
                            distance = int.MaxValue;
                            goto CacheAndReturn;
                        }
