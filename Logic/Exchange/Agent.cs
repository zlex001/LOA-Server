...
namespace Logic.Exchange
{
    public static class Agent
    {
        ...
        {
            global::Data.Warehouse warehouse = (global::Data.Warehouse)args[1];
            warehouse.monitor.Register(global::Data.Warehouse.Event.PlayerObtained, OnWarehousePlayerObtained);
        }
        private static void OnWarehousePlayerObtained(params object[] args)
        {
            global::Data.Player player = (global::Data.Player)args[0];
            global::Data.Warehouse warehouse = (global::Data.Warehouse)args[1];
            Broadcast.Instance.Local(player, new object[] { Logic.Text.Agent.Instance.Id(global::Data.Text.Labels.Acquire) }, ("warehouse", warehouse));
        }
        ...
        private static void OnAddItem(params object[] args)
        {
            ...
            if (IsContainer(item))
            {
                item.data.raw[global::Data.Item.Data.Lock] = true;
            }
        }
        private static void OnAddPlayer(params object[] args)
        {
            Player player = (Player)args[1];
            player.Content.Add.Register(typeof(global::Data.Warehouse), OnPlayerAddWarehouse);
        }
