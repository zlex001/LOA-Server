...
{
    public class Pick : Logic.Agent<Pick>
    {
                        ...
                        if (isRobbery)
                        {
                            ...
                            if (success)
                            {
                                ...
                                if (equipment.Parent is Part part)
                                {
                                    ...
                                    Broadcast.Instance.Local(sub, [Logic.Text.Agent.Instance.Id(global::Data.Text.Labels.Pick)], ("sub", sub), ("target", equipment), ("count", equipment.Count.ToString()), ("obj", obj));
                                }
                            }
            ...
            if (Can(sub, obj, count))
            {
                    ...
                    if (Justice.Robbery.Judgment(sub, owner, obj))
                    {
                        ...
                        if (success)
                        {
                            ...
                            if (obj.Parent is Part part)
                            {
                                ...
                                Broadcast.Instance.Local(sub, [Logic.Text.Agent.Instance.Id(global::Data.Text.Labels.Pick)], ("sub", sub), ("target", obj), ("count", count.ToString()), ("obj", owner));
                ...
                if (Justice.Theft.Judgment(sub, obj))
                {
                    if (sub.Content.Has(Cast.Steal.IsSkill, out Skill skill))
                    {
                        ...
                        {
                            Broadcast.Instance.Local(sub, [Logic.Text.Agent.Instance.Id(global::Data.Text.Labels.Pick)], ("sub", sub), ("target", obj), ("count", count.ToString()), ("obj", obj.Parent));
                            Receive.Do(sub, obj, count);
                            obj.monitor.Fire(Item.Event.Picked, sub);
                        }
                        else
                ...
                else
                {
                    ...
                    {
                        global::Data.Agent.Instance.monitor.Fire(global::Data.Item.Event.Picked, player, obj);
                    }
                }
            }
        }
        ...
        private static void OnBeforeLifeBearerChanged(params object[] args)
        {
            ...
            if (o != null)
            {
                ...
                Broadcast.Instance.Local(life, [Logic.Text.Agent.Instance.Id(global::Data.Text.Labels.Drop)], ("sub", o), ("obj", life));
            }

            if (v != null)
            {
                Instance.Register(v.data.after, Basic.Element.Data.Parent, life, OnAfterBearerParentChanged);
                Broadcast.Instance.Local(life, [Logic.Text.Agent.Instance.Id(global::Data.Text.Labels.Carry)], ("sub", v), ("obj", life));
            }
        }
