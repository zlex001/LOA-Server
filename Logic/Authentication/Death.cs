...
namespace Logic.Authentication
{
    public static class Death
    {
        public static void Do(global::Data.Player player)
        {
            ...
            try
            {
                global::Data.Database.Agent.Instance.Delete(player.Database);
            }
            catch (Exception ex)
            {
            ...
            global::Data.Database.Agent.Instance.Remove(player.Database);
            
            if (player.Map != null)
            {
                global::Data.Agent.Instance.Remove(player);
            }
