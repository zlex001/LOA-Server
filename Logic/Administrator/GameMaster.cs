namespace Logic.Administrator
{
    ...
    public static class GameMaster
    {
        ...
        public static Result AddGem(string playerId, int amount)
        {
            ...
            global::Data.Player player;
            if (string.IsNullOrEmpty(playerId))
            {
                player = global::Data.Agent.Instance.Content.Get<global::Data.Player>();
                if (player == null)
                {
            ...
            {
                player = global::Data.Agent.Instance.Content.Get<global::Data.Player>(p => p.Id == playerId);
                if (player == null)
                {
        ...
        public static Result TeleportAndFollow(int targetConfigId, string targetName = null)
        {
            ...
            var targetLife = Move.Distance.Nearest<global::Data.Life>(player, life =>
                life.Config?.Id == targetConfigId && !life.State.Is(global::Data.Life.States.Unconscious));
        ...
        public static Result PlayQuest(int questId, string questName = null)
        {
            ...
            var questConfig = global::Data.Config.Agent.Instance.Content.Get<global::Data.Config.Quest>(p => p.Id == questId);
            if (questConfig == null)
            {
        ...
        public static Result ExportLifeAttributes()
        {
            ...
            var lives = global::Data.Agent.Instance.Content.Gets<global::Data.Life>().ToList();
            ...
            {
                var configId = life is global::Data.Player ? 0 : (life.Config?.Id ?? 0);

                var name = life is global::Data.Player p
                    ? (p.Name ?? p.Id)
                    : (life.Config?.Name != null
                        ? Text.Agent.Instance.Get(life.Config.Name, global::Data.Text.Languages.ChineseSimplified)
                        : string.Empty);

                var parts = life.Content.Gets<global::Data.Part>();
