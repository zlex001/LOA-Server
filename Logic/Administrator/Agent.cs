...
namespace Logic.Administrator
{
    public class Agent
    {
        ...
        public void Init()
        {
            ...
            Net.Http.Instance.UriPrefixs.Add($"http://{ip}:9000/api/admin/server/create/");
            Net.Http.Instance.UriPrefixs.Add($"http://{ip}:9000/api/admin/server/update/");
            Net.Http.Instance.UriPrefixs.Add($"http://{ip}:9000/api/admin/server/delete/");
            Net.Http.Instance.UriPrefixs.Add($"http://{ip}:9000/api/administrator/debug/config/");
        ...
        private async void OnServerCreate(params object[] args)
        {
            ...
            try
            {
                ...
                var existingServer = global::Data.Database.Agent.Instance.GetServerById(id);
                ...
                var server = new global::Data.Database.Server(id, name, ip, port);
                global::Data.Database.Agent.Instance.Add(server);
                global::Data.Database.Agent.Instance.Insert(global::Data.Config.MySQL.ConnectionString, server);
        ...
        private async void OnServerUpdate(params object[] args)
        {
            ...
            try
            {
                ...
                var server = global::Data.Database.Agent.Instance.GetServerById(id);
                if (server == null)
                {
                ...
                server.ip = ip;
                server.port = port;
                global::Data.Database.Agent.Instance.Update(global::Data.Config.MySQL.ConnectionString, server);
        ...
        private async void OnServerDelete(params object[] args)
        {
            ...
            try
            {
                ...
                global::Data.Database.Agent.Instance.Remove(server);
                global::Data.Database.Agent.Instance.Delete(global::Data.Config.MySQL.ConnectionString, server);
