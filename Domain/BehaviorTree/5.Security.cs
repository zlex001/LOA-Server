    ...
    public class Security
    {
        ...
        public static bool HasKillTarget(Character character)
        {
            ...
            if (life.Map.Scene == null)
                return false;
            return Logic.Agent.Instance.Content.Has<Life>(l => l != life && !l.State.Is(Logic.Life.States.Unconscious) && l.Content.Has<Punishment>() && l.Map?.Scene == life.Birthplace?.Scene);
        ...
        public static bool IsKillTargetAdjacent(Character character)
        {
            ...
            if (life.Map == null)
                return false;
            return life.Map.Content.Has<Life>(l => l != life && !l.State.Is(Logic.Life.States.Unconscious) && l.Content.Has<Punishment>());
        }
        ...
        {
            var life = character as Logic.Life;
            var cargor = Domain.Exchange.Agent.Cargor(life);
            return cargor != null;
        }
        ...
        public static bool IsDetainTargetAdjacent(Character character)
        {
            ...
            if (life?.Map == null)
                return false;
            Life cargor = Domain.Exchange.Agent.Cargor(life);
            if (cargor == null)
                return false;
            return life.Map.Content.Has<Item>(i => Domain.Move.Enter.Can(cargor, i));
        }
        ...
        public static bool HasCaptureTarget(Character character)
        {
            ...
            if (life.Map.Scene == null)
                return false;
            return Logic.Agent.Instance.Content.Has<Life>(l => l != life && l.Content.Has<Punishment>() && l.State.Is(Life.States.Unconscious) && l.Map?.Scene == life.Birthplace?.Scene && l.Bearer == null);
        }
        ...
        public static bool HuntAndKillTarget(Character character)
        {
            ...
            if (life.Map == null)
                return false;
            if (!life.Map.Content.Has<Life>(l => l != life && !l.State.Is(Logic.Life.States.Unconscious) && l.Content.Has<Punishment>() && l.Map?.Scene == life.Birthplace?.Scene))
                return false;
            Life target = life.Map.Content.Get<Life>(l => l != life && !l.State.Is(Logic.Life.States.Unconscious) && l.Content.Has<Punishment>() && l.Map?.Scene == life.Birthplace?.Scene);
        ...
        public static bool AutoPathToKillTarget(Character character)
        {
            ...
            Life target = Logic.Agent.Instance.Content.Gets<Life>()
                .Where(l => l != life)
        ...
        public static bool Patrol(Character character)
        {
            ...
            var destination = life.Map.Scene.Content.RandomGet<Map>(m => Domain.Move.Walk.Can(life, m));
            if (destination == null)
                return false;

            Domain.Move.Walk.Do(life, destination);
            return true;
        }
        ...
        public static bool DetainTarget(Character character)
        {
            ...
            if (cargor == null)
                return false;
            if (!life.Map.Content.Has<Item>(i => Domain.Move.Enter.Can(cargor, i)))
                return false;
            Item jail = life.Map.Content.Get<Item>(i => Domain.Move.Enter.Can(cargor, i));
            Domain.Move.Enter.Do(cargor, jail);
            return true;
        }
        ...
        public static bool AutoPathToDetainTarget(Character character)
        {
            ...
            if (cargor == null)
                return false;
            Item jail = Logic.Agent.Instance.Content.Get<Item>(i => i.Map?.Scene == life.Birthplace?.Scene && Domain.Move.Enter.Can(cargor, i));
            if (jail == null)
                return false;
            Domain.Move.Walk.FollowShortest(life, jail.Map);
            return true;
        }
        ...
        public static bool CaptureTarget(Character character)
        {
            ...
            Domain.Exchange.Pick.Do(life, criminal);
            return true;
        }
