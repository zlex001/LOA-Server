...
namespace Domain.Cast
{
    public static class Steal
    {
        public static void Do(Life sub, Movement movement, Character obj, Part part)
        {
            ...
            sub.Load<Logic.Config.Buff, Logic.Buff>(Logic.Constant.ConcealmentBuff, (double)skill.Level, (double)skill.Level);
        }
        ...
        {
            Time.Agent.Period period = Domain.Time.Agent.Instance.Current.Period;
