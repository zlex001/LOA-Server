...
public class Agent : Basic.Manager
{
    ...
    public static void Do(Life life, int jailTime, Logic.Life.Crime crime)
    {
    ...
    private static void Reoffend(Punishment punishment, int newJailTime, Logic.Life.Crime crimeType)
    {
    ...
    public static void Witness(Life criminal, List<Life> witnesses, Relation.Reason reason)
    {
        foreach (var witness in witnesses)
        {
            ...
            Domain.Talk.Say.Do(witness, Logic.Text.Labels.WitnessAssault, ("criminal", criminal));
        }
    }
