...
namespace Domain.Battle
{
    public class Agent
    {
        ...
        {
            Broadcast.Instance.Local(obj, [Text.Agent.Instance.Id(Logic.Text.Labels.Hostile)], ("sub", sub), ("obj", obj));
            Domain.Relation.Interact(sub, obj, Relation.Reason.Hostile);
            
            SyncCompanionRelation(sub, obj);
            SyncCompanionRelation(obj, sub);
            
            if (Domain.Justice.Assault.Check(sub, obj))
            {
                Domain.Justice.Assault.Judge(sub, obj);
            }
        }
        ...
        private void SyncCompanionRelation(Life life, Life enemy)
        {
            ...
            {
                Domain.Relation.Do(companion, enemy, Relation.Reason.Hostile);
                Domain.Relation.Do(enemy, companion, Relation.Reason.Hostile);
            }
        }
        public void Init()
        {
