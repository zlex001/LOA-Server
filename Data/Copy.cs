...
namespace Data
{
    ...
    {
        public class Map : global::Data.Map
        {
     
        }


        public global::Data.Map Start { get; set; }
        public Quest Quest { get;  set; }
        public int[] Teleport { get; set; }
        public override void Init(params object[] args)
        {
            var start = (global::Data.Map)args[0];
            ...
            foreach (var map in start.Scene.Content.Gets<global::Data.Map>(m => Utils.Mathematics.EuclideanDistance(start.Database.pos, m.Database.pos) <= config.scope && m.Copy == null))
            {
                var database = new global::Data.Database.Map(map.Config.Id, map.Database.gid, map.Database.pos, null);
            ...
            foreach (var kvp in config.characters)
            {
                ...
                foreach (var character in characterList)
                {
                    ...
                    var characterConfig = global::Data.Config.Agent.Instance.Content.Get<Config.Ability>(c => c.Id == character.id);
        ...
        private void GenerateNestedCharactersForContainer(Item container, List<Config.Quest.Character> nestedCharacters)
        {
            ...
            {
                var characterConfig = global::Data.Config.Agent.Instance.Content.Get<Config.Ability>(c => c.Id == nestedChar.id);
