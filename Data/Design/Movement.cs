...
namespace Data.Design
{
    ...
    public class Movement :Ability
    {
        ...
        private static void ConvertRequireConditionTreeReferences(global::Data.Config.ConditionNode node)
        {
            if (node == null)
                return;
        ...
        private static string ConvertTargetFromTags(HashSet<string> tags)
        {
            ...
            {
                var allPartTypes = Enum.GetValues<global::Data.Part.Types>();
            ...
            var targetList = new List<global::Data.Part.Types>();
            foreach (var partName in targetParts)
            {
                if (Enum.TryParse<global::Data.Part.Types>(partName, true, out var partType))
                {
