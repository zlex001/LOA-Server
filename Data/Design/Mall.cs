            ...
            foreach (Mall config in Agent.Instance.Content.Gets<Mall>())
            {
                ...
                if (parsedItems.Count > 0)
                {
                    foreach (var item in parsedItems)
                    {
                        ...
                        if (itemConfig == null)
                        {
                            global::Data.Validation.Agent.Instance.Create<global::Data.Validation.Error>(
                ...
                {
                    global::Data.Validation.Agent.Instance.Create<global::Data.Validation.Error>("Multilingual key not found", "Design", "Mall", config.id.ToString(),
