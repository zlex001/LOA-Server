...
namespace Data
{
    public class Item : Character<Config.Item>, ITag
    {
        ...
        private void OnCountChangeComplete(params object[] args)
        {
            ...
            else if (Parent is global::Data.Map map)
            {
        ...
        private void ApplyPropertiesFromDatabase(Dictionary<string, string> properties)
        {
            ...
            {
                var config = global::Data.Design.Agent.Instance.Content.Gets<global::Data.Design.Life>()
            ...
            {
                var config = global::Data.Design.Agent.Instance.Content.Gets<global::Data.Design.Skill>()
        ...
        public Dictionary<string, string> CollectPropertiesForDatabase()
        {
            ...
            if (MasterId > 0)
            {
                try
                {
                    var lifeConfigs = global::Data.Design.Agent.Instance.Content.Gets<global::Data.Design.Life>();
