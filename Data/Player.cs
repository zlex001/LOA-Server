...
namespace Data
{
    ...
    public class Player : Life
    {
        ...
        {
            Database = (global::Data.Database.Player)args[0];
            Id = Database.Id;
            ...
            if (Database.signs?.Count > 0)
            {
                foreach (int signId in Database.signs.Distinct())
                {
                    ...
                    {
                        var existingSign = global::Data.Agent.Instance.Content.Get<Quest>(s => s.Config.Id == signId);
        ...
        {
            global::Data.Ability obj = (global::Data.Ability)args[0];
            Remove<Option>();
        }
        public global::Data.Map ClickTarget { get; set; }
        ...
        private void OnAfterHostelAddMe(params object[] args)
        {
            ...
            {
                Item box = hostel.Start.Create<Item>(global::Data.Config.Agent.Instance.Content.Get<Config.Item>(i => i.Type == "PrivateBox" && i.feature["Rarity"] == playerWarehouse.Level * 10000));
