...
namespace Data.Database
{
    ...
    public class Player : Basic.MySql.Data
    {
        ...
        public Dictionary<global::Data.Life.Attributes, int> grade = new();
        ...
        public override void Init(params object[] args)
        {
            ...
            grade = Utils.Json.Deserialize<global::Data.Life.Attributes, int>(Get<string>(dict, "Grade"));
        ...
        /// <summary>
        /// 正确反序列化global::Data.Database.Payment列表
        /// </summary>
            ...
            if (!string.IsNullOrEmpty(json))
            {
                try
                {
                    ...
                    foreach (var partDict in partList)
                    {
                        var part = new Part
                        {
                            Type = (global::Data.Part.Types)Convert.ToInt32(partDict["Type"]),
