...
### Logic.Config.Plot.CopyCharacter | 角色数据
...
1. **剧情触发**：玩家获得Plot时，Domain.Story检查copy字段
2. **数据解析**：Logic.Design.Plot.ParseAndConvertCopyData解析copy字符串
